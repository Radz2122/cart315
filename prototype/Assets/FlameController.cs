    ...
    void Update()
    {
       // Check if the character is facing right or left
            if (characterSpriteRenderer.flipX)
            {
                ...
                transform.position = new Vector3(characterObject.transform.position.x + xOffsetWhenFacingLeft,
            ...
            else
            {
                ...
                transform.position = new Vector3(characterObject.transform.position.x + xOffsetWhenFacingRight,
                                                 transform.position.y,
                                                 transform.position.z);
